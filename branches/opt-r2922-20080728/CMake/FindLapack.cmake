...
IF(NOT LAPACK_LIBRARY_INIT)
  ...
  IF(LAPACK_LIBRARY MATCHES "mkl")
    ...
    CHECK_SYMBOL_EXISTS(vzCIS  ${MKL_INCLUDE_DIR}/mkl_vml.h FOUND_VML)
    #TRY_COMPILE(FOUND_VML
    #  ${CMAKE_BINARY_DIR}
    #  ${PROJECT_SOURCE_DIR}/CMake/vml.cpp
    #  OUTPUT_VARIABLE VML_OUT)

    # check if mkl has vml
    #CHECK_FUNCTION_EXISTS(vzCIS FOUND_VML)
    IF(FOUND_VML)
      MESSAGE(STATUS "MKL/VML is found")
      SET(HAVE_MKL_VML 1) # CACHE BOOL "HAVE_MKL is set to 1")
    ELSE(FOUND_VML)
      MESSAGE(STATUS "MKL/VML is not found")
    ENDIF(FOUND_VML)
