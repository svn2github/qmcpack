...
int main(int argc, char** argv) {
  ...
  ComboFunc1 infunc;
  infunc.push_back(0.5,new TestFunc1(1));
  infunc.push_back(0.3,new TestFunc1(3));
  infunc.push_back(0.01,new TestFunc1(5));
  infunc.push_back(0.01,new TestFunc1(9));
  ...
  CubicBspline<double,0,true> borb;
  borb.Init(0,1.0,inData,closedEnd);
  infunc.compare(borb,"bs.dat");

  CubicSpline<double,0,true> corb;
  corb.Init(0,1.0,inData,closedEnd);
