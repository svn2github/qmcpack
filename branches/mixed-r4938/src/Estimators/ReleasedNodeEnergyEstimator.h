...
namespace qmcplusplus {
  ...
  public:
    ...
    inline void accumulate(const Walker_t& awalker, RealType wgt) 
    {
      ...
      scalars[0](ePtr[ALTERNATEENERGY],wwght);
      scalars[1](ePtr[ALTERNATEENERGY]*ePtr[ALTERNATEENERGY],wwght);
      scalars[2](ePtr[LOCALPOTENTIAL],wwght);
      scalars[3](ePtr[LOCALENERGY],wwght*std::abs(awalker.ReleasedNodeWeight));
